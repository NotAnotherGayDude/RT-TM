...
namespace nihilus {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::inp_embd, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::norm, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::attn_norm, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::qcur, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::qcur_reshaped, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::qcur_rope, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kcur, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kcur_reshaped, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kcur_rope, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::vcur, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::k_cache_view, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::k_cache_view_copy, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::vcur_transposed, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::v_cache_view, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::v_cache_view_copy, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::v, transform_type, core_type> {
		NIHILUS_FORCE_INLINE static void impl(size_t thread_index, size_t thread_count, core_type& output, const typename core_type::input_type01& cache_v) {
		}
	};

	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::k, transform_type, core_type> {
		NIHILUS_FORCE_INLINE static void impl(size_t thread_index, size_t thread_count, core_type& output, const typename core_type::input_type01& cache_k) {
		}
	};

	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::q, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kq, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kq_soft_max, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kqv, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kqv_merged, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kqv_merged_cont, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::kqv_out, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::ffn_inp, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::norm_out, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::ffn_norm, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::ffn_gate, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::ffn_silu, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::ffn_up, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::ffn_gate_par, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::ffn_out, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::l_out, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::attn_residual, transform_type, core_type> {
		NIHILUS_FORCE_INLINE static void impl(size_t thread_index, size_t thread_count, core_type& output, const typename core_type::input_type01& kqv_out,
			const typename core_type::input_type02& inp_out_ids) {
		}
	};

	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::prev_residual, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::final_norm, transform_type, core_type> {
		NIHILUS_FORCE_INLINE static void impl(size_t thread_index, size_t thread_count, core_type& output, const typename core_type::input_type01& l_out) {
		}
	};

	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::result_norm, transform_type, core_type> {
	...
	template<typename transform_type, typename core_type> struct kernel_dispatcher_impl<2, llama_op_types::result_output, transform_type, core_type> {
